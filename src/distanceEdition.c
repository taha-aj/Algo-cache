...
int main(int argc, char *argv[])
{
   ...
   //int res=edit_distance(seq[0],seq[1],(int) length[0],(int) length[1]);
   //int res=edit_distance_cache_aware(seq[0],seq[1],(int) length[0],(int) length[1],226,226);
   int res=edit_distance_cache_oblivious(seq[0],seq[1],(int) length[0],(int) length[1],200);
